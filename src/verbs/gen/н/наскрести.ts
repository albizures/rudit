...
const наскрести: PerfectVerb = {
  ...
  singular2ndPerson: Word('наскребёшь', 7),
  singular3rdPerson: Word('наскребёт', 7),
  plural1stPerson: Word('наскребём', 7),
  plural2ndPerson: Word('наскребёте', 7),
  plural3rdPerson: Word('наскребут', 7),
  masculinePast: Word('наскрёб', 5),
