...
const нагнести: PerfectVerb = {
  ...
  singular2ndPerson: Word('нагнетёшь', 1),
  singular3rdPerson: Word('нагнетёт', 1),
  plural1stPerson: Word('нагнетём', 1),
  plural2ndPerson: Word('нагнетёте', 1),
  plural3rdPerson: Word('нагнетут', 6),
  masculinePast: Word('нагнёл', 1),
