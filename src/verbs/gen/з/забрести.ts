...
const забрести: PerfectVerb = {
  ...
  singular2ndPerson: Word('забредёшь', 1),
  singular3rdPerson: Word('забредёт', 1),
  plural1stPerson: Word('забредём', 1),
  plural2ndPerson: Word('забредёте', 1),
  plural3rdPerson: Word('забредут', 6),
  masculinePast: Word('забрёл', 1),
