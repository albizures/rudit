...
const завлечь: PerfectVerb = {
  ...
  singular2ndPerson: Word('завлечёшь', 1),
  singular3rdPerson: Word('завлечёт', 1),
  plural1stPerson: Word('завлечём', 1),
  plural2ndPerson: Word('завлечёте', 1),
  plural3rdPerson: Word('завлекут', 6),
  masculinePast: Word('завлёк', 1),
