...
const запечь: PerfectVerb = {
  ...
  singular2ndPerson: Word('запечёшь', 1),
  singular3rdPerson: Word('запечёт', 1),
  plural1stPerson: Word('запечём', 1),
  plural2ndPerson: Word('запечёте', 1),
  plural3rdPerson: Word('запекут', 5),
  masculinePast: Word('запёк', 1),
