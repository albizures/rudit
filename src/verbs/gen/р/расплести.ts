...
const расплести: PerfectVerb = {
  ...
  singular2ndPerson: Word('расплетёшь', 1),
  singular3rdPerson: Word('расплетёт', 1),
  plural1stPerson: Word('расплетём', 1),
  plural2ndPerson: Word('расплетёте', 1),
  plural3rdPerson: Word('расплетут', 7),
  masculinePast: Word('расплёл', 1),
