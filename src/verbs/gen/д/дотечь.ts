...
const дотечь: PerfectVerb = {
  ...
  singular2ndPerson: Word('дотечёшь', 3),
  singular3rdPerson: Word('дотечёт', 3),
  plural1stPerson: Word('дотечём', 3),
  plural2ndPerson: Word('дотечёте', 3),
  plural3rdPerson: Word('дотекут', 5),
  masculinePast: Word('дотёк', 1),
