...
const довести: PerfectVerb = {
  ...
  singular2ndPerson: Word('доведёшь', 3),
  singular3rdPerson: Word('доведёт', 3),
  plural1stPerson: Word('доведём', 3),
  plural2ndPerson: Word('доведёте', 3),
  plural3rdPerson: Word('доведут', 5),
  masculinePast: Word('довёл', 1),
