...
const скрестись: PerfectVerb = {
  ...
  singular2ndPerson: Word('скребёшься', 5),
  singular3rdPerson: Word('скребётся', 5),
  plural1stPerson: Word('скребёмся', 5),
  plural2ndPerson: Word('скребётесь', 5),
  plural3rdPerson: Word('скребутся', 5),
  masculinePast: Word('скрёбся', 3),
