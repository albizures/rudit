...
const сплестись: PerfectVerb = {
  ...
  singular2ndPerson: Word('сплетёшься', 5),
  singular3rdPerson: Word('сплетётся', 5),
  plural1stPerson: Word('сплетёмся', 5),
  plural2ndPerson: Word('сплетётесь', 5),
  plural3rdPerson: Word('сплетутся', 5),
  masculinePast: Word('сплёлся', 3),
