...
const обойти: PerfectVerb = {
  ...
  singular2ndPerson: Word('обойдёшь', 0),
  singular3rdPerson: Word('обойдёт', 0),
  plural1stPerson: Word('обойдём', 0),
  plural2ndPerson: Word('обойдёте', 7),
  plural3rdPerson: Word('обойдут', 5),
  masculinePast: Word('обошёл', 0),
