...
const оплести: PerfectVerb = {
  ...
  singular2ndPerson: Word('оплетёшь', 5),
  singular3rdPerson: Word('оплетёт', 5),
  plural1stPerson: Word('оплетём', 5),
  plural2ndPerson: Word('оплетёте', 5),
  plural3rdPerson: Word('оплетут', 5),
  masculinePast: Word('оплёл', 3),
