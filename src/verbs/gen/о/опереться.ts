...
const опереться: PerfectVerb = {
  ...
  singular2ndPerson: Word('обопрёшься', 5),
  singular3rdPerson: Word('обопрётся', 5),
  plural1stPerson: Word('обопрёмся', 5),
  plural2ndPerson: Word('обопрётесь', 5),
  plural3rdPerson: Word('обопрутся', 5),
  masculinePast: Word('опёрся', 2),
