...
const обтечь: PerfectVerb = {
  ...
  singular2ndPerson: Word('обтечёшь', 5),
  singular3rdPerson: Word('обтечёт', 5),
  plural1stPerson: Word('обтечём', 5),
  plural2ndPerson: Word('обтечёте', 5),
  plural3rdPerson: Word('обтекут', 5),
  masculinePast: Word('обтёк', 3),
