...
const обнести: PerfectVerb = {
  ...
  singular2ndPerson: Word('обнесёшь', 5),
  singular3rdPerson: Word('обнесёт', 5),
  plural1stPerson: Word('обнесём', 5),
  plural2ndPerson: Word('обнесёте', 5),
  plural3rdPerson: Word('обнесут', 5),
  masculinePast: Word('обнёс', 3),
