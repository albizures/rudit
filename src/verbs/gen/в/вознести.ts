...
const вознести: PerfectVerb = {
  ...
  singular2ndPerson: Word('вознесёшь', 6),
  singular3rdPerson: Word('вознесёт', 6),
  plural1stPerson: Word('вознесём', 6),
  plural2ndPerson: Word('вознесёте', 6),
  plural3rdPerson: Word('вознесут', 6),
  masculinePast: Word('вознёс', 4),
