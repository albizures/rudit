...
const переплести: PerfectVerb = {
  ...
  singular2ndPerson: Word('переплетёшь', 8),
  singular3rdPerson: Word('переплетёт', 8),
  plural1stPerson: Word('переплетём', 8),
  plural2ndPerson: Word('переплетёте', 8),
  plural3rdPerson: Word('переплетут', 8),
  masculinePast: Word('переплёл', 6),
