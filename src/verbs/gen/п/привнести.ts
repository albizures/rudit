...
const привнести: PerfectVerb = {
  ...
  singular2ndPerson: Word('привнесёшь', 5),
  singular3rdPerson: Word('привнесёт', 5),
  plural1stPerson: Word('привнесём', 5),
  plural2ndPerson: Word('привнесёте', 5),
  plural3rdPerson: Word('привнесут', 7),
  masculinePast: Word('привнёс', 2),
