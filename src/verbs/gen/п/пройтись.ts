...
const пройтись: PerfectVerb = {
  ...
  singular2ndPerson: Word('пройдёшься', 5),
  singular3rdPerson: Word('пройдётся', 5),
  plural1stPerson: Word('пройдёмся', 5),
  plural2ndPerson: Word('пройдётесь', 5),
  plural3rdPerson: Word('пройдутся', 5),
  masculinePast: Word('прошёлся', 4),
