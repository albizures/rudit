...
const плестись: PerfectVerb = {
  ...
  singular2ndPerson: Word('плетёшься', 2),
  singular3rdPerson: Word('плетётся', 2),
  plural1stPerson: Word('плетёмся', 2),
  plural2ndPerson: Word('плетётесь', 2),
  plural3rdPerson: Word('плетутся', 4),
  masculinePast: Word('плёлся', 5),
