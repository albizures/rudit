...
const принести: PerfectVerb = {
  ...
  singular2ndPerson: Word('принесёшь', 6),
  singular3rdPerson: Word('принесёт', 6),
  plural1stPerson: Word('принесём', 6),
  plural2ndPerson: Word('принесёте', 6),
  plural3rdPerson: Word('принесут', 6),
  masculinePast: Word('принёс', 4),
