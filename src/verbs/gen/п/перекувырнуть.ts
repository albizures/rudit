...
const перекувырнуть: PerfectVerb = {
  ...
  singular2ndPerson: Word('перекувырнёшь', 10),
  singular3rdPerson: Word('перекувырнёт', 10),
  plural1stPerson: Word('перекувырнём', 10),
  plural2ndPerson: Word('перекувырнёте', 10),
