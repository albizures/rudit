...
const подвести: PerfectVerb = {
  ...
  singular2ndPerson: Word('подведёшь', 4),
  singular3rdPerson: Word('подведёт', 4),
  plural1stPerson: Word('подведём', 4),
  plural2ndPerson: Word('подведёте', 4),
  plural3rdPerson: Word('подведут', 6),
  masculinePast: Word('подвёл', 1),
