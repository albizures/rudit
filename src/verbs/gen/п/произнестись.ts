...
const произнестись: PerfectVerb = {
  ...
  singular2ndPerson: Word('произнесёшься', 6),
  singular3rdPerson: Word('произнесётся', 6),
  plural1stPerson: Word('произнесёмся', 6),
  plural2ndPerson: Word('произнесётесь', 6),
  plural3rdPerson: Word('произнесутся', 8),
  masculinePast: Word('произнёсся', 3),
