...
const перетечь: PerfectVerb = {
  ...
  singular2ndPerson: Word('перетечёшь', 1),
  singular3rdPerson: Word('перетечёт', 1),
  plural1stPerson: Word('перетечём', 1),
  plural2ndPerson: Word('перетечёте', 1),
  plural3rdPerson: Word('перетекут', 7),
  masculinePast: Word('перетёк', 1),
